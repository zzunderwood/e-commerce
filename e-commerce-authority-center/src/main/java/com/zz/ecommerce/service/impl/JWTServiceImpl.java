package com.zz.ecommerce.service.impl;
import com.alibaba.fastjson.JSON;
import com.zz.ecommerce.constant.AuthorityConstant;
...
public class JWTServiceImpl implements IJWTService {
    ...
    public String generateToken(String username, String password, int expire) throws Exception {
        ...
        //Token 中塞入对象，即JWT 中存储的信息，后端拿到这个信息，可以知道哪个用户在操作
